        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-300 max-w-lg">
              A curious and passionate student at Millburn High School, deeply
              fascinated by the world of computer engineering. I'm driven by a
              love for learning and a desire to understand how technology can be
              used to create, connect, and care for others.
            </p>
          </div>
