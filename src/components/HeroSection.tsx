...
const HeroSection: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[90vh] sm:min-h-[80vh] flex items-center pt-24 md:pt-32 pb-16 md:pb-24 bg-gradient-to-br from-blue-50 via-white to-blue-100"
    >
      ...
      <div className="section-container relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-3/5 md:pr-8 text-center md:text-left">
            ...
            <h1
              ref={nameRef}
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-portfolio-navy mb-4 leading-tight"
            >
              Luke Zang
            </h1>
            ...
            <p className="text-portfolio-gray text-base sm:text-lg mb-8 max-w-lg mx-auto md:mx-0 animate-fade-in animation-delay-500">
              Aspiring computer scientist and innovator with experience in AI,
              web development, and automation. Passionate about building
              technologies that connect people and make the world smarter and
              kinder.
            </p>{" "}
            <div className="flex flex-wrap gap-4 justify-center md:justify-start animate-fade-in animation-delay-700">
              <Button
                asChild
                className="bg-portfolio-blue hover:bg-blue-700 transform transition-all hover:translate-y-[-3px] shadow-lg hover:shadow-blue-200"
              >
                <a
                  href="#contact"
              ...
              <Button
                variant="outline"
                asChild
                className="border border-portfolio-blue text-portfolio-blue hover:bg-blue-50 transition-all hover:translate-y-[-3px]"
              >
                <a
                  href="#projects"
            ...
            <div className="mt-8 flex items-center justify-center md:justify-start space-x-5 animate-fade-in animation-delay-1000">
              <a
                ...
                className="text-portfolio-gray hover:text-portfolio-blue transition-all transform hover:scale-110"
              >
                <svg
          ...
          <div className="md:w-2/5 mt-10 md:mt-0 animate-fade-in animation-delay-1000">
            ...
            {/* Decorative element */}
            <div
              className="absolute -z-0 w-72 h-72 md:w-96 md:h-96 bg-blue-50 rounded-full blur-md opacity-70 animate-pulse"
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce hidden sm:flex">
        <a
          ...
          className="flex flex-col items-center text-portfolio-gray hover:text-portfolio-blue transition-colors"
        >
